...
export default function Register() {
    ...
    const profileAvatar='./images/Avatar.png';
    const userDetails = {
        username: name,
        email: email,
        password: pass,
    ...
    const handleSubmit = (evt) => {
        ...
        if (name == '') {
            ...
            alert("password should be 5 chaeacter")
        }
            ...
            fetch('http://192.168.0.111:8000/users/register', {
                method: "POST",
                ...
                .then(res => {
                    ...
                    if (res.status == true) {
                        ...
                        setStep2Value(ct.Active)
                        setStepValue(ct.Active1)
                        console.log(res.status, "status...")
                        alert(res.message)
                    }
                    else{
                        console.log("open server for api ")
                    }
                })
                                        ...
                                        <div className={ct.profile_coln_left}>
                                            <div className={ct.profile_upload}>
                                                <label classNameName="">
                                                    ...
                                                    <img src={profileimg === '' ? profileAvatar: profileimg}
                                                        alt="Profile" style={{ borderRadius: '100%', width: '150px', height: '150px', padding: '2px' }} />Upload
                                                    <input type="file" id="myfile" name="myfile" className="form-control" className={ct.input_type} onChange={onImageChange} /></label>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div className="row">
                                                <div className="col-md-6 col-sm-12">
                                                    <div className={ct.Input}>
                                                        ...
                                                        <input type="text" value={name} id="name" name="fname" className="form-control" onChange={(e) => setName(e.target.value)} />
                                                    </div>
                                                </div>
                                                <div className="col-md-6 col-sm-12">
                                                    <div className={ct.Input}>
